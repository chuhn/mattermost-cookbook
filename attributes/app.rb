# default_unless['mattermost']['app']['service_settings'] = {
#   'site_url' => '',
#   'websocket_url' => '',
#   'license_file_location' => '',
#   'listen_address' => ':8065',
default_unless['mattermost']['app']['service_settings']['listen_address'] = ':8065'
#   'connection_security' => '',
#   'tls_cert_file' => '',
#   'tls_key_file' => '',
#   'tls_min_ver' => '1.2',
...
#   'enable_latex' => true,
# }
# default_unless['mattermost']['app']['image_proxy_settings'] = {
...
# default_unless['mattermost']['app']['team_settings'] = {
...
# default_unless['mattermost']['app']['client_requirements'] = {
...
# default_unless['mattermost']['app']['notification_log_settings'] = {
#   'enable_console' => true,
#   'console_level' => 'DEBUG',
#   'console_json' => true,
#   'enable_file' => true,
...
# default_unless['mattermost']['app']['log_settings'] = {
#   'enable_console' => true,
#   'console_level' => 'DEBUG',
#   'console_json' => true,
#   'enable_file' => true,
...
#   'file_json' => true,
#   'file_location' => '/var/log/mattermost',
default_unless['mattermost']['app']['log_settings']['file_location'] = '/var/log/mattermost'
#   'enable_webhook_debugging' => true,
#   'enable_diagnostics' => true,
# }

# default_unless['mattermost']['app']['password_settings'] = {
#   'minimum_length' => 5,
#   'lowercase' => false,
#   'number' => false,
#   'uppercase' => false,
...
# default_unless['mattermost']['app']['file_settings'] = {
#   'enable_file_attachments' => true,
#   'enable_mobile_upload' => true,
#   'enable_mobile_download' => true,
#   'max_file_size' => 52428800,
#   'driver_name' => 'local',
#   'directory' => './data/', # relative path makes no sense here m(
default_unless['mattermost']['app']['file_settings']['directory'] = node['mattermost']['config']['data_dir']
...
# default_unless['mattermost']['app']['email_settings'] = {
...
# default_unless['mattermost']['app']['rate_limit_settings'] = {
#   'enable' => false,
#   'per_sec' => 10,
#   'max_burst' => 100,
...
# default_unless['mattermost']['app']['privacy_settings'] = {
#   'show_email_address' => true,
#   'show_full_name' => true,
# }

# default_unless['mattermost']['app']['support_settings'] = {
...
# default_unless['mattermost']['app']['announcement_settings'] = {
#   'enable_banner' => false,
#   'banner_text' => '',
#   'banner_color' => '#f2a93b',
...
# default_unless['mattermost']['app']['theme_settings'] = {
...
# default_unless['mattermost']['app']['gitlab_settings'] = {
#   'enable' => false,
#   'secret' => '',
#   'id' => '',
#   'scope' => '',
...
# default_unless['mattermost']['app']['google_settings'] = {
#   'enable' => false,
#   'secret' => '',
#   'id' => '',
#   'scope' => 'profile email',
...
# default_unless['mattermost']['app']['office_365_settings'] = {
#   'enable' => false,
#   'secret' => '',
#   'id' => '',
#   'scope' => 'User.Read',
...
# default_unless['mattermost']['app']['ldap_settings'] = {
#   'enable' => false,
#   'enable_sync' => false,
#   'ldap_server' => '',
#   'ldap_port' => 389,
...
# default_unless['mattermost']['app']['compliance_settings'] = {
#   'enable' => false,
#   'directory' => './data/',
#   'enable_daily' => false,
# }

# default_unless['mattermost']['app']['localization_settings'] = {
#   'default_server_locale' => 'en',
#   'default_client_locale' => 'en',
#   'available_locales' => '',
# }

# default_unless['mattermost']['app']['saml_settings'] = {
#   'enable' => false,
...
# default_unless['mattermost']['app']['native_app_settings'] = {
...
# default_unless['mattermost']['app']['cluster_settings'] = {
#   'enable' => false,
#   'cluster_name' => '',
#   'override_hostname' => '',
#   'use_ip_address' => true,
...
# default_unless['mattermost']['app']['metrics_settings'] = {
#   'enable' => false,
#   'block_profile_rate' => 0,
#   'listen_address' => ':8067',
# }

# default_unless['mattermost']['app']['experimental_settings'] = {
...
# default_unless['mattermost']['app']['analytics_settings']['max_users_for_statistics'] = 2500

# default_unless['mattermost']['app']['webrtc_settings'] = {
#   'enable' => false,
...
# default_unless['mattermost']['app']['elastic_search_settings'] = {
...
# default_unless['mattermost']['app']['data_retention_settings'] = {
...
# default_unless['mattermost']['app']['message_export_settings'] = {
#   'enable_export' => false,
...
# default_unless['mattermost']['app']['job_settings'] = {
#   'run_jobs' => true,
#   'run_scheduler' => true,
# }

# default_unless['mattermost']['app']['plugin_settings'] = {
#   'enable' => true,
#   'enable_uploads' => false,
#   'directory' => 'plugins',
#   'client_directory' => 'client/plugins',
default_unless['mattermost']['app']['plugin_settings']['client_directory'] = 'client/plugins'
...
# default_unless['mattermost']['app']['guest_accounts_settings'] = {
#   'enable' => false,
